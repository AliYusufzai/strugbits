...
import EditCustomer from "../utility-component/EditCustomer";
...
export default function Table() {
  ...
  const handleShowEditCustomer = (customerId) => {
    dispatch(setCustomerId(customerId));
    setShowEditCustomer(true);
  };
  //Handling Modal functionality Ends here
        ...
        {customers.map((customer) => (
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-start gap-2 tableButtons">
              ...
              <button
                onClick={() => {
                  handleShowEditCustomer(customer._id);
                }}
                className="py-[9px] px-[40px] w-full xl:max-w-[106px]  text-[16px] font-semibold text-green-700 bg-green-600 bg-opacity-[.4] rounded-[5px]"
              >
                Edit
              </button>
              <button
